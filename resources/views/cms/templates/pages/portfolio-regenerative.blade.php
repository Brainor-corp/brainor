...
@section('anim-images-bg')
    <img src="{{asset('img/portfolios/regenerative/partials-bg/mikro.png')}}" alt="" class="img-fluid first-bg-item floating-portfolio-bg">
    <img src="{{asset('img/portfolios/regenerative/partials-bg/steto.png')}}" alt="" class="img-fluid second-bg-item floating-portfolio-bg">
@endsection
