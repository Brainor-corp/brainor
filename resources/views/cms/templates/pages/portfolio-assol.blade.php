...
@section('anim-images-bg')
    <img src="{{asset('img/portfolios/assol/partials-bg/zajim.png')}}" alt="" class="img-fluid first-bg-item floating-portfolio-bg">
    <img src="{{asset('img/portfolios/assol/partials-bg/scalpel.png')}}" alt="" class="img-fluid second-bg-item floating-portfolio-bg">
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="mocups-row">
                    <div class="mac">
                        @include('v1.partials.mocups.mac', ['path' => asset('img/portfolios/assol/full-height-main.png')])
                    </div>
                    <div class="ipad">
                        @include('v1.partials.mocups.ipad', ['path' => asset('img/portfolios/assol/full-main-ipad.png')])
                    </div>
                    <div class="iphone">
                        @include('v1.partials.mocups.iphone', ['path' => asset('img/portfolios/assol/full-main-iphone.png')])
                    </div>
                </div>
            </div>
        </div>
