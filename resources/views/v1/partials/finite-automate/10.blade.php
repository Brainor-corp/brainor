...
<div class="price-calculation-steps-row row justify-content-around">
    ...
    <div class="steps px-0 col-auto"><span id="step3" class="past nav-step">Страницы</span></div>
    <div class="steps px-0 col-auto"><span id="step4" class="active nav-step">Итог</span></div>
</div>
