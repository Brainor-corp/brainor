...
<div class="price-calculation-steps-row row justify-content-around">
    ...
    <div class="steps px-0 col-auto"><span id="step2" class="active past">Дизайн</span></div>
</div>
<div class="mt-4 px-3 px-md-0 row justify-content-around">
    ...
    <div id="choice1" class="my-4 my-md-0 col-md-6 col-12 next text-center align-self-center priceable" data-price="5000">
