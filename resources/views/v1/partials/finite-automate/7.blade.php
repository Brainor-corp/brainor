...
<div class="price-calculation-steps-row mb-5 row justify-content-around">
    ...
    <div class="steps px-0 col-auto"><span id="step4" class="past">Функционал</span></div>
    <div class="steps px-0 col-auto"><span id="step5" class="active past">Итог</span></div>
</div>
<div class=" mt-5 row justify-content-around">
    <div class="my-5 col-12 text-center align-self-center">
        <h3>Предварительная цена составляет <span class="final-price"></span> <i class="fa fa-ruble-sign"></i>.</h3>
    </div>
</div>