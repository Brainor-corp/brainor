...
<div class="price-calculation-steps-row row justify-content-around">
    ...
    <div class="steps px-0 col-auto"><span id="step4" class="past nav-step">Функционал</span></div>
    <div class="steps px-0 col-auto"><span id="step5" class="active nav-step">Итог</span></div>
</div>
