<div class="mx-4 my-lg-5 my-3">
    <div class="row">
        ...
        <p class="col-12 text-center">
            <button class="btn hvr-bounce-to-bottom bg-transparent" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Веб-фреймворк для языка PHP</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Веб-фреймворк для языка JavaScript</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Cистема управления содержимым сайта</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Cистема управления содержимым сайта от компании 1C</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Технология обращения к серверу без перезагрузки страницы</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Расширяемый язык разметки</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Веб-сервер и почтовый прокси-сервер, работающий на Unix-подобных операционных системах</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 pl-md-0 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <span>Оъектно-реляционная система управления базами данных</span>
                            </div>
                        </div>
                    </div>
                </div>
