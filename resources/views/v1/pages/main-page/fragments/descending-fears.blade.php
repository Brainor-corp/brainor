            ...
            <ul class="nav flex-column" id="myTab" role="tablist">
                ...
                @foreach($fears as $fear)
                    <li class="nav-item fear-block">
                        <a class="nav-link py-5 d-flex flex-row @if($i==0) active @endif flex-nowrap" id="tab{{$fear->id}}" data-toggle="tab" href="#fear{{$fear->id}}" role="tab" aria-controls="fear{{$fear->id}}" aria-selected="true">
